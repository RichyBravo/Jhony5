...
Auto3ScaleX2Left::Auto3ScaleX2Left(double wait) {
	...
	AddSequential	(new CmdDrivePID(208, 0, 1.0, Drive::encoderAverage, true, true, 5, false));		// Drive to platform WAS 210!!!
	...
	AddSequential	(new CmdDrivePID(-176, 90, 1.0, Drive::encoderAverage, true, false, 5, false));		// Drive backward in front of platform
	...
	AddSequential	(new CmdDrivePID(35, 0, 0.7, Drive::encoderAverage, true, false, 3, false));		// Drive toward Scale WAS 35
	...
	AddSequential	(new CmdRotatePID(158, 0.7, false, 3, false));										// Rotate toward Switch
	AddSequential	(new CmdDrivePID(28, 158, 0.9, Drive::encoderAverage, true, false , 3, false));		// Drive to Switch
	...
	AddSequential	(new CmdLiftPosition(dvLiftScaleTop, false, false));								// Move Lift to Scale Top position
	AddSequential	(new CmdDrivePID(-64, 152, 0.9, Drive::encoderAverage, true, false , 4, false));	// Drive backward toward Scale
